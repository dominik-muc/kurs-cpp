...
public:
    ...
    std::string to_string() const override { return "sin(" + (this->e1)->to_string() + ")"; }
...
public:
    ...
    std::string to_string() const override { return "cos(" + (this->e1)->to_string() + ")"; }
...
public:
    ...
    std::string to_string() const override { return "exp(" + (this->e1)->to_string() + ")"; }
...
public:
    ...
    std::string to_string() const override { return "ln(" + (this->e1)->to_string() + ")"; }
...
public:
    ...
    std::string to_string() const override { return "|" + (this->e1)->to_string() + "|"; }
